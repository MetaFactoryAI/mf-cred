...
count?: [{	columns?:ValueTypes["contribution_votes_select_column"][],	distinct?:boolean | null},boolean],
...
["contributions"]: AliasType<{
	...
	category?:boolean,
contributors?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["contributors_bool_exp"] | null},ValueTypes["contributors"]],
contributors_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contributors_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["contributors_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contributors_bool_exp"] | null},ValueTypes["contributors_aggregate"]],
	created_at?:boolean,
	created_by?:boolean,
	date?:boolean,
	description?:boolean,
	...
	impact?:boolean,
	title?:boolean,
votes?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["contribution_votes_bool_exp"] | null},ValueTypes["contribution_votes"]],
votes_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contribution_votes_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["contribution_votes_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contribution_votes_bool_exp"] | null},ValueTypes["contribution_votes_aggregate"]],
	weight?:boolean,
		__typename?: boolean
}>;
...
count?: [{	columns?:ValueTypes["contributions_select_column"][],	distinct?:boolean | null},boolean],
...
["contributions_order_by"]: {
	...
	contributors_aggregate?:ValueTypes["contributors_aggregate_order_by"] | null,
	created_at?:ValueTypes["order_by"] | null,
	...
	votes_aggregate?:ValueTypes["contribution_votes_aggregate_order_by"] | null,
...
count?: [{	columns?:ValueTypes["contributors_select_column"][],	distinct?:boolean | null},boolean],
...
delete_contribution_votes?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["contribution_votes_bool_exp"]},ValueTypes["contribution_votes_mutation_response"]],
delete_contribution_votes_by_pk?: [{	contribution_id:ValueTypes["uuid"],	user_id:ValueTypes["uuid"]},ValueTypes["contribution_votes"]],
delete_contributions?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["contributions_bool_exp"]},ValueTypes["contributions_mutation_response"]],
delete_contributions_by_pk?: [{	id:ValueTypes["uuid"]},ValueTypes["contributions"]],
delete_contributors?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["contributors_bool_exp"]},ValueTypes["contributors_mutation_response"]],
delete_contributors_by_pk?: [{	contribution_id:ValueTypes["uuid"],	user_id:ValueTypes["uuid"]},ValueTypes["contributors"]],
delete_shop_api_users?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["shop_api_users_bool_exp"]},ValueTypes["shop_api_users_mutation_response"]],
delete_shop_api_users_by_pk?: [{	username:string},ValueTypes["shop_api_users"]],
delete_shop_product_locks?: [{	/** filter the rows which have to be deleted */
	where:ValueTypes["shop_product_locks_bool_exp"]},ValueTypes["shop_product_locks_mutation_response"]],
delete_shop_product_locks_by_pk?: [{	access_code:string,	lock_id:string},ValueTypes["shop_product_locks"]],
...
update_contribution_votes?: [{	/** sets the columns of the filtered rows to the given values */
	...
	where:ValueTypes["contribution_votes_bool_exp"]},ValueTypes["contribution_votes_mutation_response"]],
update_contribution_votes_by_pk?: [{	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["contribution_votes_set_input"] | null,	pk_columns:ValueTypes["contribution_votes_pk_columns_input"]},ValueTypes["contribution_votes"]],
update_contributions?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["contributions_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["contributions_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["contributions_bool_exp"]},ValueTypes["contributions_mutation_response"]],
update_contributions_by_pk?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["contributions_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["contributions_set_input"] | null,	pk_columns:ValueTypes["contributions_pk_columns_input"]},ValueTypes["contributions"]],
update_contributors?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["contributors_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["contributors_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["contributors_bool_exp"]},ValueTypes["contributors_mutation_response"]],
update_contributors_by_pk?: [{	/** increments the numeric columns with given value of the filtered values */
	_inc?:ValueTypes["contributors_inc_input"] | null,	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["contributors_set_input"] | null,	pk_columns:ValueTypes["contributors_pk_columns_input"]},ValueTypes["contributors"]],
update_shop_api_users?: [{	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["shop_api_users_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["shop_api_users_bool_exp"]},ValueTypes["shop_api_users_mutation_response"]],
update_shop_api_users_by_pk?: [{	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["shop_api_users_set_input"] | null,	pk_columns:ValueTypes["shop_api_users_pk_columns_input"]},ValueTypes["shop_api_users"]],
update_shop_product_locks?: [{	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["shop_product_locks_set_input"] | null,	/** filter the rows which have to be updated */
	where:ValueTypes["shop_product_locks_bool_exp"]},ValueTypes["shop_product_locks_mutation_response"]],
update_shop_product_locks_by_pk?: [{	/** sets the columns of the filtered rows to the given values */
	_set?:ValueTypes["shop_product_locks_set_input"] | null,	pk_columns:ValueTypes["shop_product_locks_pk_columns_input"]},ValueTypes["shop_product_locks"]],
...
contribution_votes?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contribution_votes_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["contribution_votes_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contribution_votes_bool_exp"] | null},ValueTypes["contribution_votes"]],
contribution_votes_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contribution_votes_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["contribution_votes_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contribution_votes_bool_exp"] | null},ValueTypes["contribution_votes_aggregate"]],
contribution_votes_by_pk?: [{	contribution_id:ValueTypes["uuid"],	user_id:ValueTypes["uuid"]},ValueTypes["contribution_votes"]],
contributions?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["contributions_bool_exp"] | null},ValueTypes["contributions"]],
contributions_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contributions_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["contributions_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contributions_bool_exp"] | null},ValueTypes["contributions_aggregate"]],
contributions_by_pk?: [{	id:ValueTypes["uuid"]},ValueTypes["contributions"]],
contributors?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["contributors_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
...
contributors_aggregate?: [{	/** distinct select on columns */
	...
	order_by?:ValueTypes["contributors_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["contributors_bool_exp"] | null},ValueTypes["contributors_aggregate"]],
contributors_by_pk?: [{	contribution_id:ValueTypes["uuid"],	user_id:ValueTypes["uuid"]},ValueTypes["contributors"]],
shop_api_users?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["shop_api_users_bool_exp"] | null},ValueTypes["shop_api_users"]],
shop_api_users_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["shop_api_users_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["shop_api_users_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["shop_api_users_bool_exp"] | null},ValueTypes["shop_api_users_aggregate"]],
shop_api_users_by_pk?: [{	username:string},ValueTypes["shop_api_users"]],
shop_product_locks?: [{	/** distinct select on columns */
	...
	where?:ValueTypes["shop_product_locks_bool_exp"] | null},ValueTypes["shop_product_locks"]],
shop_product_locks_aggregate?: [{	/** distinct select on columns */
	distinct_on?:ValueTypes["shop_product_locks_select_column"][],	/** limit the number of rows returned */
	limit?:number | null,	/** skip the first n rows. Use only with order_by */
	offset?:number | null,	/** sort the rows by one or more columns */
	order_by?:ValueTypes["shop_product_locks_order_by"][],	/** filter the rows returned */
	where?:ValueTypes["shop_product_locks_bool_exp"] | null},ValueTypes["shop_product_locks_aggregate"]],
shop_product_locks_by_pk?: [{	access_code:string,	lock_id:string},ValueTypes["shop_product_locks"]],
...
count?: [{	columns?:ValueTypes["shop_api_users_select_column"][],	distinct?:boolean | null},boolean],
...
count?: [{	columns?:ValueTypes["shop_product_locks_select_column"][],	distinct?:boolean | null},boolean],
